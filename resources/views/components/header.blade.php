                            ...
                            <div class="position-relative">
                                <div class="row">
                                    ...
                                    <div class="col-4 d-none d-lg-flex">
                                        <img src="{{ asset('images/backgrounds/mega-dd-bg.jpg') }}" alt="mega-dd"
                    ...
                    <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                        ...
                        <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                            <a class="nav-link position-relative" href="javascript:void(0)" id="drop2"
                                ...
                                <span class="cartCount position-absolute top-0 start-100 translate-middle badge text-sm rounded-pill bg-danger">
                                    0
                                </span>
                            </a>
                            ...
                            <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                                ...
                                <div class="d-flex align-items-center justify-content-between py-3 px-7">
                                    <h5 class="mb-0 fs-5 fw-semibold">Cart</h5>
                                ...
                                <div class="py-6 px-7 mb-1">
                                    <a href="{{ route('quotation.view') }}" class="btn btn-primary w-100">Download Quotation</a>
                                </div>
                                ...
                                <div class="position-relative px-4 pt-3 pb-2">
                                    ...
                                    <div class="message-body">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <button type="submit"
                                                class="p-2 dropdown-item h6 rounded-1">Logout</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
