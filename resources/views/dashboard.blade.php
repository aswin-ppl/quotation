                                        ...
                                        <div class="position-relative">
                                            <div class="row">
                                                ...
                                                <div class="col-4 d-none d-lg-flex">
                                                    <img src="{{ asset('images/backgrounds/mega-dd-bg.jpg') }}"
                                ...
                                <ul
                                    ...
                                    <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                                        <a class="nav-link" href="javascript:void(0)" id="drop2"
                                            ...
                                            <img src="{{ asset('images/flag/icon-flag-en.svg') }}" alt="matdash-img"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up"
                                            ...
                                            <div class="message-body">
                                                <a href="javascript:void(0)"
                                                    ...
                                                    <div class="position-relative">
                                                        <img src="{{ asset('images/flag/icon-flag-en.svg') }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('images/flag/icon-flag-cn.svg') }}"
                                                            alt="matdash-img" width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20" />
                                                    </div>
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('images/flag/icon-flag-fr.svg') }}"
                                                            alt="matdash-img" width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20" />
                                                    </div>
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                                                    <div class="position-relative">
                                                        <img src="{{ asset('images/flag/icon-flag-sa.svg') }}"
                                                            alt="matdash-img" width="20px" height="20px"
                                                            class="rounded-circle object-fit-cover round-20" />
                                                    </div>
                                        ...
                                        <div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up"
                                            ...
                                            <div class="position-relative px-4 pt-3 pb-2">
                                                ...
                                                <div class="message-body">
                                                    ...
                                                    <a href="authentication-login2.html"
                                                        class="p-2 dropdown-item h6 rounded-1">
                                                        Sign Out
                                                    </a>
                                                </div>
                        ...
                        <ul id="sidebarnav">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link" href="frontend-aboutpage.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link" href="frontend-blogpage.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link" href="frontend-blogdetailpage.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link" href="frontend-contactpage.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link" href="frontend-portfoliopage.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link" href="frontend-pricingpage.html"
                                            aria-expanded="false">
                                            <span class="rounded-3">
                                                <i class="ti ti-circle"></i>
                                            </span>
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="https://bootstrapdemos.adminmart.com/matdash/dist/main/apps-kanban.html"
                                            class="sidebar-link">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    ...
                                    <li class="sidebar-item">
                                        <a href="https://bootstrapdemos.adminmart.com/matdash/dist/landingpage/index.html"
                                            class="sidebar-link">
                            ...
                            <li class="sidebar-item">
                                ...
                                <ul aria-expanded="false" class="collapse first-level">
                                    <li class="sidebar-item">
                                        <a href="https://adminmart.github.io/premium-documentation/bootstrap/matdash/index.html"
                                            class="sidebar-link">
                                            <i class="ti ti-circle"></i>
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5 text-center text-md-end">
                                            <img src="{{ asset('images/backgrounds/welcome-bg.png') }}"
                                ...
                                <div class="card-body pb-4">
                                    <div class="d-md-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <div class="hstack gap-9 mt-4 mt-md-0">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <span
                                                    class="d-block flex-shrink-0 round-8 bg-danger rounded-circle"></span>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-column align-items-center gap-2 w-100 mt-3">
                                                <div class="d-flex align-items-center gap-2 w-100">
                                                    <span
                                                        class="d-block flex-shrink-0 round-8 bg-primary rounded-circle"></span>
                                                    <h6 class="fs-3 fw-normal text-muted mb-0">April 07 - April 14
                                                    </h6>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card mb-lg-0">
                                <div class="card-body">
                                    <div
                                        class="d-flex flex-wrap gap-3 mb-9 justify-content-between align-items-center">
                                    ...
                                    <div class="table-responsive">
                                        <ul class="nav nav-tabs theme-tab gap-3 flex-nowrap" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="index.html#mobile"
                                                    role="tab">
                                                    <div class="hstack gap-2">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="index.html#saas"
                                                    role="tab">
                                                    <div class="hstack gap-2">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="index.html#other"
                                                    role="tab">
                                                    <div class="hstack gap-2">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="ps-0">
                                                                <div class="d-flex align-items-center gap-6">
                                                                    <img src="{{ asset('images/products/dash-prd-1.jpg') }}"
                                                                        alt="prd1" width="48"
                                                                        class="rounded" />
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            <td class="ps-0">
                                                                <div class="d-flex align-items-center gap-6">
                                                                    <img src="{{ asset('images/products/dash-prd-2.jpg') }}"
                                                                        alt="prd1" width="48"
                                                                        class="rounded" />
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            <td class="ps-0">
                                                                <div class="d-flex align-items-center gap-6">
                                                                    <img src="{{ asset('images/products/dash-prd-3.jpg') }}"
                                                                        alt="prd1" width="48"
                                                                        class="rounded" />
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            <td class="ps-0">
                                                                <div class="d-flex align-items-center gap-6">
                                                                    <img src="{{ asset('images/products/dash-prd-4.jpg') }}"
                                                                        alt="prd1" width="48"
                                                                        class="rounded" />
                                                                    <div>
