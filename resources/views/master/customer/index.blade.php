            ...
            <div class="d-flex flex-row-reverse my-3">
                <div class="card-header d-flex justify-content-between align-items-center">
                    @can('create-customers')
                        <a href="{{ route('customers.create') }}" class="btn btn-sm btn-primary">Create New Customer</a>
                    @endcan
                </div>
            </div>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr>
                                <td>
                                    <span class="fw-normal">{{ $customer->name }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="fw-normal"> {{ $customer->mobile }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="fw-normal"> {{ $customer->status }}</span>
                                    </div>
                                </td>
                                <td>
                                    @if ($customer->trashed())
                                        @can('restore-customers')
                                            <a href="{{ route('customers.restore', $customer) }}"
