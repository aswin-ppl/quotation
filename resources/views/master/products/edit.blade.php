                        ...
                        <div class="row">
                            ...
                            <div class="mb-4">
                                ...
                                <table class="table table-bordered align-middle" id="descriptionTable">
                                    ...
                                    <tbody id="descBody">
                                        @php
                                            $descriptions = old('descriptions', $product->descriptions ?? []);
                                        @endphp
                                        @forelse ($descriptions as $i => $desc)
                                            <tr>
                                                <td>
                                        ...
                                        @empty
                                            <tr>
                                                <td><input type="text" name="descriptions[0][key]"
                                                        class="form-control" placeholder="e.g. Brand"></td>
                                                <td><input type="text" name="descriptions[0][value]"
                                                        class="form-control" placeholder="e.g. Bosch"></td>
                                                <td class="text-center">
                                                    <button type="button" class="btn btn-primary btn-sm addRow">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24">
