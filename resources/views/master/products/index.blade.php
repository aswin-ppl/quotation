        ...
        <div class="container-fluid">
            ...
            <div class="bg-white p-3 rounded">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div>
                        <!-- Page length will be controlled by DataTables -->
                    </div>
                </div>

                <div class="table-responsive">
                    <table id="products-table" class="table text-nowrap mb-0 align-middle display nowrap"
                        style="width:100%">
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#products-table').DataTable({
                ajax: {
                    ...
                    error: function(xhr, error, thrown) {
                        ...
                        console.error('Products AJAX error', xhr.status, thrown, xhr.responseText);
                        toastr.error('Failed to load products. See console for details.');
                    }
                },
                columns: [{
                        data: 'product',
                ...
                createdRow: function(row, data, dataIndex) {
                    // mark trashed rows so the client-side filter can work
            ...
            // Status filter (All / Active / Trashed)
